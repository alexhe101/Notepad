...
public class MainScreenController {
	...
	public void clickFindButton(ActionEvent event) {
		// Parent root = FXMLLoader.load(getClass().getResource("FindScreen.fxml"));
		// Scene scene = new Scene(root,400,400);
		// scene.getStylesheets().add(getClass().getResource("application.css").toExternalForm());
		// Stage findScrren = new Stage();
		// findScrren.setScene(scene);
		// findScrren.show();
		FXMLLoader fxmlLoader = new FXMLLoader();
		fxmlLoader.setLocation(getClass().getResource("FindScreen.fxml"));
		try {
			Parent root = fxmlLoader.load();
			FindScreenController s = fxmlLoader.getController();
